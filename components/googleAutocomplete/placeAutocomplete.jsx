...
const PlaceAutocomplete = ({
  ...
  return (
    <Modal
       ...
       >
         <SafeAreaView style={styles.modalContainer} keyboardShouldPersistTaps='always'>
           <View style={styles.modalHeader} keyboardShouldPersistTaps='always'>
             <TouchableOpacity onPress={() => setModalVisible(false)}>
               <Ionicons name="arrow-back" size={24} color="black" />
             </TouchableOpacity>
             <Text style={styles.modalTitle}>
               {currentField === 'from' ? 'Select Departure' : 'Select Destination'}
             </Text>
             <View style={{ width: 24 }} />
           </View>
           
           <GooglePlacesAutocomplete
             placeholder={currentField === 'from' ? "Enter departure city" : "Enter destination city"}
             minLength={2}
             autoFocus={true}
