                ...
                <View style={styles.modalContent}>
                    ...
                    >
                                ...
                                >
                                    ...
                                    <View style={styles.suggestionContent}>
                                        <View style={styles.suggestionHeader}>
                                            ...
                                            <Text style={styles.popularityTag}>{suggestion.popularity}</Text>
                                        </View>
                                        ...
                                        >
                                            <Text style={[styles.categoryTagText, { color: suggestion.color }]}>
                                                {suggestion.category}
                                            </Text>
                                        </View>
                                    </View>
                        ...
                        <View style={styles.recentSearches}>
                            {['Tokyo luxury hotels', 'Flights to Paris', 'Best beaches in Hawaii'].map((item, index) => (
                                <TouchableOpacity
                                    key={index}
