            ...
            <View style={styles.travelerContent}>
                <View style={styles.travelerType}>
                    ...
                    <View style={styles.counter}>
                        <Pressable
                            style={[styles.counterButton, travelers.adults <= 1 && styles.buttonDisabled]}
                            onPress={() => updateTravelerCount('adults', false)}
                            disabled={travelers.adults <= 1}>
                            <Text style={travelers.adults <= 1 ? styles.counterButtonTextDisabled : styles.counterButtonText}>-</Text>
                        </Pressable>
                ...
                <View style={styles.travelerType}>
                    ...
                    <View style={styles.counter}>
                        <Pressable
                            style={[styles.counterButton, travelers.children === 0 && styles.buttonDisabled]}
                            onPress={() => updateTravelerCount('children', false)}
                            disabled={travelers.children === 0}>
                            <Text style={travelers.children === 0 ? styles.counterButtonTextDisabled : styles.counterButtonText}>-</Text>
                        </Pressable>
                ...
                <View style={styles.travelerType}>
                    ...
                    <View style={styles.counter}>
                        <Pressable
                            style={[styles.counterButton, travelers.infants === 0 && styles.buttonDisabled]}
                            onPress={() => updateTravelerCount('infants', false)}
                            disabled={travelers.infants === 0}>
                            <Text style={travelers.infants === 0 ? styles.counterButtonTextDisabled : styles.counterButtonText}>-</Text>
                        </Pressable>
                        <Text style={styles.count}>{travelers.infants}</Text>
                        <Pressable
                            style={[styles.counterButton, travelers.infants >= travelers.adults && styles.buttonDisabled]}
                            onPress={() => updateTravelerCount('infants', true)}
                            disabled={travelers.infants >= travelers.adults}>
                            <Text style={travelers.infants >= travelers.adults ? styles.counterButtonTextDisabled : styles.counterButtonText}>+</Text>
                        </Pressable>
                    </View>
                </View>
            </View>
            ...
            <ScrollView
                ...
                <Animated.View
                    ...
                    {shouldShowField('from') && (
                        <Pressable
                            ...
                            <Text style={styles.searchValue}>
                                {fromLocation ? `${fromLocation.name} (${fromLocation.code})` : 'Select departure'}
                            </Text>
                        </Pressable>
                    )}
                    ...
                    <Pressable
                        ...
                        <Text style={styles.searchValue}>
                            {toLocation ? `${toLocation.name} (${toLocation.code})` : 'Select destination'}
                        </Text>
                    </Pressable>
                    ...
                    <View style={[styles.travelersContainer, isTravelersDropdownOpen && styles.travelersContainerActive]}>
                        ...
                        {isTravelersDropdownOpen && <TravelersDropdown travelers={travelers} setTravelers={setTravelers} />}
                    </View>
                </Animated.View>
                ...
                <Animated.View
                    ...
                    <Pressable
                        style={[
                            styles.searchButton,
                            isSearchDisabled() ? styles.searchButtonDisabled : styles.searchButtonEnabled
                        ]}
